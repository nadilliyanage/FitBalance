...
const HealthData = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              const updatedRecords = pastRecords.filter(
  ...
  const getHealthComment = () => {
    ...
    if (submittedData.totalCholesterolRange === "240+") {
      comment +=
        " Total cholesterol is high. Consult a healthcare professional.";
  ...
  return (
    <SafeAreaView className="bg-gray-50 flex-1 pt-4 px-2">
      ...
      {submittedData ? (
        <View className="mb-5 p-4 border border-gray-300 rounded-lg bg-white h-min">
          ...
          <View className="bg-white shadow-xl shadow-black rounded-lg p-4">
            <Text className="mb-2 text-lg ml-4 font-bold">
              Hemoglobin: {submittedData.hemoglobinRange} (g/dL)
            </Text>
            <Text className="mb-2 text-lg ml-4 font-bold">
              Blood Sugar: {submittedData.bloodSugarRange} (mg/dL)
            </Text>
            <Text className="mb-2 text-lg ml-4 font-bold">
              Total Cholesterol: {submittedData.totalCholesterolRange} (mg/dL)
            </Text>
            <Text className="mb-2 text-lg ml-4 font-bold">
              HDL Cholesterol: {submittedData.hdlRange} (mg/dL)
            </Text>
            <Text className="mb-2 text-lg ml-4 font-bold">
              LDL Cholesterol: {submittedData.ldlRange} (mg/dL)
            </Text>
            <Text className="mb-2 text-lg ml-4 font-bold">
              Triglycerides: {submittedData.triglyceridesRange} (mg/dL)
            </Text>
          </View>
          ...
          <View className=" absolute bottom-0 mx-14 my-16  ">
            <TouchableOpacity
              ...
              className="bg-yellow-500 p-4 rounded-xl mb-8 w-16 ml-64"
            >
            ...
            <TouchableOpacity
              onPress={deleteHealthData}
              className="bg-red-500 p-4 rounded-xl mb-8 w-16  ml-64"
            >
              <Text className="text-white text-center text-lg">
            ...
            <TouchableOpacity
              ...
              className="bg-blue-500 p-4 rounded-xl mb-4 w-16  ml-64"
            >
              <Text className="text-white text-center text-lg">
        ...
        <View className="flex mx-6 mb-6">
          <TouchableOpacity
            onPress={() => setModalVisible(true)}
            className=" bg-secondary-300 p-10  mb-4 rounded-xl"
          >
          ...
          <TouchableOpacity
            onPress={() => setRecordsModalVisible(true)}
            className="bg-secondary p-4 rounded-xl mb-4"
          >
            ...
            <View className="bg-white  shadow-2xl shadow-black w-11/12 rounded-lg p-4 h-[75%]">
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {pastRecords.map((record, index) => (
                  <View
                    key={index}
                    className="bg-secondary border border-gray-300 rounded-lg p-4 mr-4 mt-2 w-fit "
                  >
                    <Text className="mt-2 mb-6 text-xl font-pmedium text-white">
                      Hemoglobin: {record.hemoglobinRange}
                    </Text>
                    <Text className="mb-6 text-xl font-pmedium text-white ">
                      Blood Sugar: {record.bloodSugarRange}
                    </Text>
                    <Text className="mb-6 text-xl font-pmedium text-white">
                      Total Cholesterol: {record.totalCholesterolRange}
                    </Text>
                    <Text className="mb-6 text-xl font-pmedium text-white">
                      HDL: {record.hdlRange}
                    </Text>
                    ...
                    <Text className="mb-6 text-xl font-pmedium text-white">
                      Triglycerides: {record.triglyceridesRange}
                    </Text>
                    <Text className="mb-6 text-xl font-pmedium text-white">
                      Date: {record.date}
                    </Text>
                    <TouchableOpacity
                      onPress={() => deletePastRecord(index)}
                      className="bg-white p-2 m-4 rounded-lg flex absolute bottom-0 right-0 w-14 "
                    >
            ...
            <View className="bg-purple-200 w-11/12 rounded-lg p-6 ">
              ...
              <View className="mb-4 bg-white p-2 rounded-lg">
                ...
                <Picker
                  ...
                  style={{ height: 50 }}
                  onValueChange={setHemoglobinRange}
                >
              ...
              <View className="mb-4 bg-white p-2 rounded-lg">
                ...
                <Picker
                  ...
                  style={{ height: 50 }}
                  onValueChange={setBloodSugarRange}
                >
                  <Picker.Item label="Select range" value="" />
              ...
              <View className="mb-4 bg-white p-2 rounded-lg">
                ...
                <Picker
                  ...
                  style={{ height: 50 }}
                  onValueChange={setTotalCholesterolRange}
                >
                  <Picker.Item label="Select range" value="" />
              ...
              <View className="mb-4 bg-white p-2 rounded-lg">
                ...
                <Picker
                  ...
                  style={{ height: 50 }}
                  onValueChange={setTriglyceridesRange}
                >
                  <Picker.Item label="Select range" value="" />
              ...
              <TouchableOpacity
                ...
                className="bg-purple-500 p-3 rounded-xl mb-2 flex-row items-center justify-center"
              >
