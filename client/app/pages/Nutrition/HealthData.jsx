    ...
    <SafeAreaView className="bg-gray-50 flex-1 pt-4 px-4">
      ...
      {submittedData ? (
        <View className="mb-5 p-4 border border-gray-300 rounded-lg bg-white h-min">
          <Text className="text-3xl font-semibold mb-10 text-center">
            Submitted Health Data
          </Text>
          <View className="bg-white shadow-xl shadow-black rounded-lg p-4">
            <Text className="mb-2 text-xl ml-4 font-bold">
              Hemoglobin: {submittedData.hemoglobinRange} sfgs
            </Text>
            <Text className="mb-2 text-xl ml-4 font-bold">
              Blood Sugar: {submittedData.bloodSugarRange}
            </Text>
            <Text className="mb-2 text-xl ml-4 font-bold">
              Total Cholesterol: {submittedData.totalCholesterolRange}
            </Text>
            <Text className="mb-2 text-xl ml-4 font-bold">
              HDL Cholesterol: {submittedData.hdlRange}
            </Text>
            <Text className="mb-2 text-xl ml-4 font-bold">
              LDL Cholesterol: {submittedData.ldlRange}
            </Text>
            <Text className="mb-2 text-xl ml-4 font-bold">
              Triglycerides: {submittedData.triglyceridesRange}
            </Text>
          </View>
